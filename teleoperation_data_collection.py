...
# CSV 轨迹文件保存到 data/trajectory；D435i RGB 视频保存到 data/video。
...
def run_teleop_record_session(cmd_queue, initial_mode, record_file, enable_camera_recording=None, camera_recorder=None):
    """
    运行遥操作/遥操作记录会话。
