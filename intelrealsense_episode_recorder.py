...
class D435iRecorder:
    """
    Intel RealSense D435i RGB 实时预览与同步录制模块（episode目录版）。
    ...
    默认输出文件：
        data/episode_xx/video/<record_stem>_color.mp4
        data/episode_xx/video/<record_stem>_camera_timestamps.csv
        data/episode_xx/video/<record_stem>_camera_meta.json
    """
    ...
    def start_record(self, video_dir: str, record_stem: str, record_start_time: float) -> bool:
        ...
        参数：
            video_dir: 本次 episode_xx/video 目录
